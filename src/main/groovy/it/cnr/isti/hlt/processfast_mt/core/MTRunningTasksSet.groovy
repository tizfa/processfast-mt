...
import it.cnr.isti.hlt.processfast_mt.connector.MTConnector
import it.cnr.isti.hlt.processfast_mt.connector.MTBarrier

/**
 * @author Tiziano Fagni (tiziano.fagni@isti.cnr.it)
 */
class MTRunningTasksSet implements ConnectorManager {
     ...
     */
    MTRunningTasksSet tasksSetParent
     ...
     */
    HashMap<String, MTRunningTask> tasksDeclared = [:]
     ...
     */
    HashMap<String, MTBarrier> barriers = [:]
