 ...
 * @since 1.0.0
 */
class MTBroadcastVirtualConnectorReader {

    /**
     * The source connector.
     */
    final MTBroadcastQueueConnector sourceConnector
    ...
    MTBroadcastVirtualConnectorReader(MTBroadcastQueueConnector sourceConnector) {
